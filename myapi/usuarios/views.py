...
from .models import User, Publication, Connection, FavoritesList, WatchList
from .serializers import UserSerializer, PublicationSerializer, FavoritesListSerializer, WatchlistSerializer
